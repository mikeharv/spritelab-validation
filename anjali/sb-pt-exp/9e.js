// https://levelbuilder-studio.code.org/s/sb-pt-exp/lessons/1/levels/9/sublevel/5
/*
Use an event to create another sprite when one is clicked.
Challenge: Create multiple new sprites at different locations with one sprite is clicked.
*/
