//Deprecated; level is now free play.
...
var foundImmune=false;
for(var i=0; i<animations.length;i++){
  //console.log(defaultCostumes);
  //console.log(animations);
  for(var j=0; j<defaultCostumes.length;j++){
    if(animations[i]==defaultCostumes[j]){
      foundMatch=true;
      //console.log(animations[i] + " found");
    }
  }
  if(!foundMatch){
    foundImmune=true;
    //console.log(animations[i] + " is new");
  }
  foundMatch=false;
